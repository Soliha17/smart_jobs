  ...
  return (
    <div className="mock-hero container">
      <div className="content__mock-hero">
        <p className="badge__mock-hero">Ish intervyulari</p>
        <p className="title__mock-hero">
          Mock intervyular bilan yangi bosqichga chiqing
        </p>
        <p className="subtitle__mock-hero">
          Bizning "Mock Interview Qilish Servisi" sizni ishga tayyorgarlik
          jarayonida yordam berish uchun tuzilgan.
        </p>
      </div>
      <div className="group__mock-hero">
        ...
        <button>Intervyu topshirish</button>
